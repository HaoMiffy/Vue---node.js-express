<template>
  <div class="about">
    ...
    <tr v-for="user in usesrs" :key="user.id">
      ...
      <td>
        <div>
          <label for="remark">patch remark</label>
          <input type="text" id="remark" v-model="patch.remark" />
...
export default{
  ...
  methods:{
    ...
    edit(id){
      axios.patch('https://amobile.node-watch.com/deviceManagement/deviceType/'+ id,this.patch)
        .then(response => {
          console.log(response)
          console.log('patch成功')
        })
